...
export default function TaskCard({ task, onStatusChange }: TaskCardProps) {
  ...
  return (
    <div className="bg-gray-900/80 border border-gray-800 rounded-xl p-4 hover:border-gray-600 transition-all animate-fade-in">
      <div className="flex items-start justify-between mb-3">
        <h4 className="text-white font-medium text-sm flex-1 mr-3">{task.title}</h4>
